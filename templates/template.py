class Template(object):
    ...
    <table border="1" style="width: 100%; max-width: 360px; border-collapse: collapse; background-color: #FFF6E6; font-family: Arial, sans-serif; font-weight: bold; font-color: #FFB752; border-color: #FF852E;">
        ...
        <td style="width: 25%;">
            <p style="color:brown;font-size:12px;text-align:left;">2<br><br><br><br></p>
            <p style="color:brown;font-size:10px;text-align:right;">மேஷம்</p>
        </td>
        <td style="width: 25%;">
            <p style="color:brown;font-size:12px;text-align:left;">3<br><br><br><br></p>
        ...
        <td>
            <p style="color:brown;font-size:12px;text-align:left;">10<br><br><br><br></p>
            <p style="color:brown;font-size:10px;text-align:right;">விருச்</p>
        </td>
        <td>
            <p style="color:brown;font-size:12px;text-align:left;">11<br><br><br><br></p>
